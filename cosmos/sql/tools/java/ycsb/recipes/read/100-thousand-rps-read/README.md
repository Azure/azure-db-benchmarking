...
This recipe encapsulates a read only workload with a maximum requests per second of 100 thousand. This "1-Click" recipe combines both the load and run phases of YCSB.
...
| Workload | Read |
| Max RPS | 100 Thousand |
| Duration | 1 Hour |
| Number of documents in DB |10,000 |
...
1. Create a [Cosmos DB SQL API container](https://learn.microsoft.com/en-us/azure/cosmos-db/nosql/quickstart-portal)
   ...
   | Container throughput | 120,000 RU/s[^1] |
...
[![Deploy to Azure](https://aka.ms/deploytoazurebutton)](https://portal.azure.com/#create/Microsoft.Template/uri/https%3A%2F%2Fraw.githubusercontent.com%2FAzure%2Fazure-db-benchmarking%2Fmain%2Fcosmos%2Fsql%2Ftools%2Fjava%2Fycsb%2Frecipes%2Fread%2F100-thousand-rps-read%2Fazuredeploy.json)
