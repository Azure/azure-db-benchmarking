...
This recipe encapsulates a update only workload with a maximum requests per second of 500 thousand. This "1-Click" recipe combines both the load and run phases of YCSB.
