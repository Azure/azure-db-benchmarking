...
## Try it
1. Create a [cosmos DB SQL API account](https://learn.microsoft.com/en-us/azure/cosmos-db/nosql/quickstart-portal) and note down the endpoint and primary key 
