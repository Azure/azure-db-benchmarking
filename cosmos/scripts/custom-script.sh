...
ycsb_folder_name="ycsb-${ycsbbindingname}-binding-*-SNAPSHOT"
user_home="/home/${ADMIN_USER_NAME}"

echo "########## Extracting YCSB ##########"
tar xfvz ycsb-${ycsbbindingname}-binding*.tar.gz
cp ./*-run.sh ./$ycsb_folder_name
cp ./${ycsbbindingname}.properties ./$ycsb_folder_name
