...
> **Note**
> ***We have added a client-side chaos tool that allows users to validate the resiliency of their applications during unexpected events. Please navigate to [Getting Started](/cosmos/sql/tools/java/ycsb/chaos/network-faults) page for more details.***
